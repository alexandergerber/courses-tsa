...
arma11 <- arima(con_supply2010_random1, order = c(1,0,1))
...
3. If ACF/PACF don't give a clear answer, choose appropriate candidate models and use the AIC to determine the "best".
